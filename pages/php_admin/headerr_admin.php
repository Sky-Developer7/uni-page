...
<body>
    ...
    <div class="system">
        ...
        <div class="dropdown_menu">
            <a href="../inf_student/student.php">إضافة</a><br>
            <a href="../inf_student/search_student.php">بحث</a><br>
            <a href="../inf_student/list_student.php">قائمة طالبه</a><br>
            <a href="../inf_student/login_student.php">تسجيل الدخول</a><br>
        </div>
        </div>
